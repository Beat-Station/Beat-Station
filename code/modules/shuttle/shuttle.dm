...
/obj/machinery/computer/shuttle/trade
	...
	var/docking_request_message = "A trading ship has requested docking aboard the NSS Athena for trading. This request can be accepted or denied using a communications console."
...
/obj/machinery/computer/shuttle/trade/sol
	...
	shuttleId = "trade_sol"
	docking_request_message = "A trading ship of Sol origin has requested docking aboard the NSS Athena for trading. This request can be accepted or denied using a communications console."
